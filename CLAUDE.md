# StudyMind — Claude Project Instructions
...
| File | Purpose |
|------|---------|
| `C:\Users\rocks\Documents\CLaude\StudyMind\app.py` | Main Gradio app |
| `modules\quiz.py` | Quiz generation logic |
| `modules\flashcards.py` | Flashcard logic |
| `modules\mindmap.py` | Mindmap logic |
| `C:\Users\rocks\Documents\CLaude\Memory\memory.md` | Session memory file |
